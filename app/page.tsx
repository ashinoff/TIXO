...
<div className="hero-bottom"><a className="scroll-cue" href="#aromas">Почувствовать тишину <span aria-hidden="true">↓</span></a></div>
</section>
<ScentDiscovery />
<Catalog />
...
<footer className="footer footer-ritual pad">
  <div className="footer-top"><span>Аромат. Свет. Тишина.</span><a href="#home">Вернуться к началу <span aria-hidden="true">↑</span></a></div>
  <div className="footer-signature"><a className="footer-wordmark" href="#home" aria-label="ТИХО — наверх">тихо</a><div><p>Для вечеров,<br />которые хочется повторить.</p><nav aria-label="Навигация в конце страницы"><a href="#collection">Коллекция ↗</a><a href="#studio">Твоя мастерская ↗</a></nav></div></div>
