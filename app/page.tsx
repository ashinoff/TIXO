...
import { ShoppingProvider, Catalog, Aroma, ScentDiscovery, CartOverlay, CartTrigger } from "./components/storefront-commerce";
...
export default function Home() {
  ...
  <header className="header" id="header"><a className="wordmark" href="#home" aria-label="ТИХО — на главную">тихо<span className="brand-period">.</span></a><nav aria-label="Основная навигация"><a href="#collection">Коллекция</a><a href="#workshop">Мастерская</a><a href="#aromas">Ароматы</a></nav><CartTrigger /></header>
