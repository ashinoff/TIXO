...
export function ScentDiscovery() {
  ...
  return <section className="scent-discovery pad" id="aromas" aria-labelledby="scent-discovery-title">
    <div className="scent-discovery-heading"><p className="eyebrow">01 / ИСКУССТВО АРОМАТА</p><h2 id="scent-discovery-title">Форма притягивает взгляд.<br /><span>Аромат остаётся в памяти.</span></h2><p>Начните с ощущения. Выберите аромат для своего вечера.</p></div>
...
export function Catalog() {
  ...
  return <section className="collection pad" id="collection" aria-labelledby="collection-title">
    <div className="section-heading"><div><p className="eyebrow">02 / КОЛЛЕКЦИЯ</p><h2 id="collection-title">У тишины<br />ваша форма.</h2></div><p className="section-description">Любимый цвет. Любимый аромат.<br />Сочетание выбираете вы.</p></div>
